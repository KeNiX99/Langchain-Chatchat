...
def anydialogue_page(api: ApiRequest, is_lite: bool = False):
    ...
    with st.sidebar:
        ...
        #prompt_template_name = "knowledge_base_chat"
        ...
        '''
        prompt_template_select = 'law-agent'
        print('prompt_template_select==>')
        print(prompt_template_select)
        #prompt_template_name = st.session_state.prompt_template_select
        prompt_template_name = 'law-agent'
